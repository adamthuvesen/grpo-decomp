# grpo-decomp decontamination (the GSM8K elicitation finding off the memorizable distribution)
...
- **Contamination is a pass@1 effect, not a pass@8 one.** Renumbering costs base pass@1 ~11 pp
  ...
  *envelope*, which the elicitation verdict rests on, holds under this control. The §3 greedy
...
inflate is pass@1 (greedy first-try), exactly where the §3 controls already located it. The

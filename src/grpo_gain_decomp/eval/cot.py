...
An LLM-as-judge is deliberately not used: it would breach the verifiable-only
discipline and add a runtime dependency. The trade-off is coverage — completions

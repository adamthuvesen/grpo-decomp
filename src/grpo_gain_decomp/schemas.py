"""Canonical, strict data schemas shared across grpo_gain_decomp.

Every dataset grpo_gain_decomp touches — GSM8K and its perturbation/clean-label controls —
...
class Record(BaseModel):
    """Base for all grpo_gain_decomp records: immutable, and unknown fields are an error."""
...
class Problem(Record):
    """One math problem in grpo_gain_decomp's canonical schema, identical across all datasets.

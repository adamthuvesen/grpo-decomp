"""docs <-> JSON consistency guard for committed headline numbers.
...
This replaces manual grep: regenerate an artifact and a stale doc number fails CI;
edit a doc number away from its source and it fails too.
...
_SUM = _load("results/summary.json")  # GSM8K seed-0 controls
